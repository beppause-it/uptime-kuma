...
class UptimeKumaServer {
    ...
    async sendMonitorList(socket) {
        ...
        // Broadcast to ALL authenticated sockets so every user sees the same monitors.
        this.io.emit("monitorList", list);
        return list;
    }
    ...
    async getMonitorJSONList(userID = null, monitorID = null) {
        // Monitors are shared across all users — no user_id filter.
        let query = "1=1 ";
        let queryParams = [];
